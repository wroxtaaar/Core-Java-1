...
class Main {
  ...
  public static void main(String[] args) throws JsonParseException, JsonMappingException, IOException {
    ...
    File trades = new File("src/main/java/com/crio/session1/activity2/trades.json");

    // POJO to be serialized to Output File
    File outputFile = new File("src/main/java/com/crio/session1/activity2/readOutput.json");
