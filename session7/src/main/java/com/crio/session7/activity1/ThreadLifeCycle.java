...
public class ThreadLifeCycle implements Runnable{
 ...
 public static void main(String[] args) {
  ...
  System.out.println("State of " + thread1.getName() + " after creating it - " + thread1.getState());
  thread1.start();

  // thread1 moved to Runnable state
  System.out.println("State of " + thread1.getName() + " after calling start() method on it - " + thread1.getState());
 ...
 public void run() {
  ...
  // thread1 created and is currently in the NEW state.
  System.out.println("State of " + thread2.getName() + " after creating it - " + thread2.getState());
  thread2.start();

  // thread2 moved to Runnable state
  System.out.println("State of " + thread2.getName() + " after calling start() method on it - " + thread2.getState());
